        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Editing Parent #{{ $parent->id }}</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('parents.update', $parent) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            ...
                            <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="birthdate" type="date" class="form-control" name="birthdate" value="{{ $parent->birthdate or old('birthdate') }}" required>
