                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('students.update', $student) }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ $student->name or old('name')  }}" maxlength="100" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" name="email" value="{{ $student->email or old('email') }}" maxlength="120" required>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="tel" class="form-control" name="phone" value="{{ $student->phone or old('phone') }}" maxlength="14" required>
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address" value="{{ $student->address or old('address') }}" maxlength="100" required>
